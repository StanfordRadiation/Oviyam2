...
public class ImageHandler extends SimpleTagSupport {
     ...
     * @param dcmURL String object registers the dcmURL
     */
     ...
     * This method will send the ImageInfo to generate a HTML page during its execution.
     *
    ...
    public void doTag() throws JspException, IOException {
		...
		//getJspContext().setAttribute("instanceNumber", instance.getInstanceNumber());
                ...
                getJspContext().setAttribute("instanceNumber", instanceCount+1);
