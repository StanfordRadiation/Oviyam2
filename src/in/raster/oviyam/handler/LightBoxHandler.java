...
/**
 * Generates the code used to display the main image in the center of the app
 *  
 * @author jeffm
 * @version 1.0
 * 
 * Example: The Jsp code that uses the ImageHandler class as Tag.
 ...
 * 		<BODY> 
 * 			<TABLE>
 * 				<img:LightBox patientId="${param.patientID}" study="${param.studyID}" seriesId="${param.seriesID}" objectID="${param.instanceID}">
 * 					<TR>
 * 						<TD>${imageId}</TD>
 ...
 *
 */
public class LightBoxHandler extends SimpleTagSupport {
	
	/*
	 * Initialize logger
	 */	
	private static Logger log = Logger.getLogger(LightBoxHandler.class);
	...
	public void doTag() throws JspException, IOException {		
		try {
			...
			AE ae = new AE();
			imageInfo.callFindWithQuery(patientId, study, seriesId, objectId);
		} catch (Exception e) {
			e.printStackTrace();
